...
/**
 * Classe de teste para demonstrar as operações GET (Listar) utilizando a arquitetura POO.
 */
public class select {

    public static void main(String[] args) {
        System.out.println("=== TESTE DE LISTAGEM POO (AXIS) ===");
        ...
        if (projetos.isEmpty()) {
            ...
            for (Projeto p : projetos) {
                System.out.println("ID: " + p.getId() + " | Nome: " + p.getNomeProjeto() + " | Status: " + p.getStatus());
            }
        }
